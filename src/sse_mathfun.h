...
#ifndef INCLUDED_SSE_MATHFUN_H
#define INCLUDED_SSE_MATHFUN_H
...
/* natural logarithm computed for 4 simultaneous float 
   return NaN for x <= 0
*/
static inline __attribute__((always_inline,const,artificial)) v4sf
log_ps(v4sf x) {
#ifdef USE_SSE2
  v4si emm0;
#else
...
static inline __attribute__((always_inline,const,artificial)) void
