...
#define MLE_GAMMA_DEFAULT_SHAPE 3.0f
#endif

#ifndef MLE_GAMMA_DEFAULT_RATE
#define MLE_GAMMA_DEFAULT_RATE (MLE_GAMMA_DEFAULT_SHAPE / MLE_GAMMA_DEFAULT_MEAN)
#endif

#ifndef MLE_GAMMA_DEFAULT_OFFSET
#define MLE_GAMMA_DEFAULT_OFFSET ((MLE_GAMMA_DEFAULT_SHAPE - 1.0f) / MLE_GAMMA_DEFAULT_RATE)
#endif
